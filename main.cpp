...
void menu(){ //Menu de lo que puede hacer el programa 
	cout<<"Biesnvenido al programa de Facturas online"<<endl;
...
int main() {
	...
	while(continua ==0){ //ciclo del programa
		...
		if(opcion==1){ //Condicional para escoger una opción
			...
			Cliente cliente1(producto1,"Eduardo","Viveros","Queretaro",45454511,Fecha(3,12));//objeto cliente composicion de producto
